...
import { Image, CaretRight, DiscordLogo, FileArrowDown, Lightning } from "phosphor-react";
    ...
    return(
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gep-16">
                    <div className="flex-1">
                ...
                <div className="gap-8 mt-8 grid grid-cols-2">
                    ...
                    <a className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors" href="">
                        ...
                        <div className="py-6 leanding-relaxed">
                            ...
                            <p className="text-xs text-gray-200 mt-2">
                                Baixe wallpapers exclusivos do Igint Lab e personalize sua máquina
                            </p>
                        </div>
                        <div className="h-full p-6 flex items-center">
                            <CaretRight size={24} />
